...
export async function generateMetadata({
  ...
  const title = article ? `${article.title.pt} | LAB` : "Artigo | LAB";
  const description = article?.summary.pt || "Artigo técnico sobre sistemas agênticos de IA.";
...
export default async function Page({
  ...
  const { slug } = await params;
  return <InsightArticleDocument language="pt" forceLanguage slug={slug} />;
}
