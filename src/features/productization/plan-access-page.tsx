...
import { CreditCard, ExternalLink, KeyRound, Layers3, ShieldCheck } from "lucide-react";
      ...
      <div className="space-y-5">
        ...
        <Panel className="border-[var(--border-default)] bg-white p-5">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-[18px] font-semibold text-[var(--text-primary)]">Solicitudes pendientes</h3>
          </div>
