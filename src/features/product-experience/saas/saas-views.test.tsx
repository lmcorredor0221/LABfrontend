...
function createAcpWorkspace(
  ...
  return {
    ...
    phase_definitions: [
      { key: "acp_input_readiness", label: "Readiness de insumos ACP", objective: "Validar insumos", order: 1, required: true },
      { key: "acp_questions_resolution", label: "Resolucion de preguntas ACP", objective: "Preguntas", order: 2, required: true },
      { key: "acp_test_suite", label: "Test Suite ACP", objective: "Test suite", order: 3, required: true },
      { key: "acp_graphic_simulation", label: "Simulacion grafica ACP", objective: "Simular", order: 4, required: true },
      { key: "acp_quality_gates", label: "Quality gates ACP", objective: "Clasificar", order: 5, required: true },
      { key: "acp_artifact_reconciliation", label: "Reconciliacion de artefactos ACP", objective: "Reconciliar", order: 6, required: true },
      { key: "acp_package_build", label: "Empaquetamiento ACP", objective: "Empaquetar", order: 7, required: true },
      { key: "acp_download_ready", label: "Readiness de descarga ACP", objective: "Exportar", order: 8, required: true },
    ],
    phases: [
      {
        attempt_count: 1,
        ...
        phase_label: "Readiness de insumos ACP",
        phase_order: 1,
      ...
      },
      {
        ...
        phase_label: "Resolucion de preguntas ACP",
        phase_order: 2,
        started_at: null,
        status: "not_started",
        updated_at: "2026-08-26T18:11:00Z",
      ...
      },
      {
        ...
        input_refs: [],
        output_refs: [],
        phase_key: "acp_test_suite",
        phase_label: "Test Suite ACP",
        phase_order: 3,
        started_at: null,
        status: "not_started",
        updated_at: "2026-08-26T18:11:00Z",
      ...
      },
      {
        ...
        input_refs: [],
        output_refs: [],
        phase_key: "acp_graphic_simulation",
        phase_label: "Simulacion grafica ACP",
        phase_order: 4,
        started_at: null,
        status: "not_started",
        updated_at: "2026-08-26T18:11:00Z",
      ...
      },
      {
        ...
        input_refs: [],
        output_refs: [],
        phase_key: "acp_artifact_reconciliation",
        phase_label: "Reconciliacion de artefactos ACP",
        phase_order: 6,
        started_at: null,
        status: "not_started",
        updated_at: "2026-08-26T18:11:00Z",
      ...
      },
      {
        ...
        input_refs: [],
        output_refs: [],
        phase_key: "acp_package_build",
        phase_label: "Empaquetamiento ACP",
        phase_order: 7,
        started_at: null,
        status: "not_started",
        updated_at: "2026-08-26T18:11:00Z",
      ...
      },
      {
        ...
        input_refs: [],
        output_refs: [],
        phase_key: "acp_download_ready",
        phase_label: "Readiness de descarga ACP",
        phase_order: 8,
        started_at: null,
        status: "not_started",
        updated_at: "2026-08-26T18:11:00Z",
    ...
    run: {
      ...
      current_phase_key: "acp_quality_gates",
      id: "run-1",
      phase_order: [
        "acp_input_readiness",
  ...
  it("reprocesses ACP deliverables through the workspace phase instead of legacy generation", async () => {
    ...
    await waitFor(() =>
      expect(mockSessionsApi.runAcpWorkspacePhase).toHaveBeenCalledWith(
        ...
        "acp_artifact_reconciliation",
        expect.objectContaining({
          idempotency_key: expect.stringContaining("session-uxa11:acp_artifact_reconciliation:"),
        }),
      ),
    );
    ...
    mockSessionsApi.getAcpQuestions.mockResolvedValueOnce([
      {
        ...
        impact_analysis: {
          affected_phase_keys: ["acp_questions_resolution", "acp_artifact_reconciliation", "acp_download_ready"],
      ...
      },
      {
        ...
        impact_analysis: {
          affected_phase_keys: ["acp_questions_resolution", "acp_artifact_reconciliation"],
          affected_stage_keys: ["acp", "package"],
          impact_kind: "localized_impact",
          impact_summary: "La respuesta impacta artefactos localizados.",
          material_impact: true,
          recommended_action: "Reconciliar entregables ACP al actualizar artefactos.",
